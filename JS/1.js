    ...
    processOne: function(key, settings, context) {
        ...
        apachesolr_autocomplete_search.autocomplete({
            ...
            select: function(event, ui) {
                console.log("autocomplete.select: " + ui.item.value);
                //TODO: Debug
...
(function($, Drupal) {
   ...
   */
    Drupal.moment.dateLimitFormatDate = function(format) {
        return format.replace(/h|H|m|s/g, '').replace(/^[\s,'"\.:;\-]+/g, '').replace(/[\s,'"\.:;\-]+$/g, '');
    }
    ;
...
(function(Drupal) {
    ...
    Drupal.behaviors.momentInitialize = {
        attach: function() {
            ...
            moment.defineLocale(Drupal.moment.getInterfaceLanguageCode(), {
                months: [Drupal.t('January', {}, {
                ...
                monthsShort: [Drupal.t('Jan'), Drupal.t('Feb'), Drupal.t('Mar'), Drupal.t('Apr'), Drupal.t('May'), Drupal.t('Jun'), Drupal.t('Jul'), Drupal.t('Aug'), Drupal.t('Sep'), Drupal.t('Oct'), Drupal.t('Nov'), Drupal.t('Dec')],
                ...
                weekdaysShort: [Drupal.t('Sun'), Drupal.t('Mon'), Drupal.t('Tue'), Drupal.t('Wed'), Drupal.t('Thu'), Drupal.t('Fri'), Drupal.t('Sat')],
                weekdaysMin: [Drupal.t('Su', {}, {
                    'context': 'day_abbr2'
                }), Drupal.t('Mo', {}, {
                    'context': 'day_abbr2'
                }), Drupal.t('Tu', {}, {
...
;!function(c, M) {
    ...
    "use strict";
    var M, p = {}, n = {}, L = {}, q = {}, c = o.version.split("."), z = +c[0], A = +c[1];
    function a(c) {
    ...
    function b(c) {
        ...
        for (45 === c.charCodeAt(0) && (n = -(M = 1)); M < A.length; M++)
            p = 60 * p + a(A.charCodeAt(M));
        for (M = 0; M < b.length; M++)
            o /= 60,
            p += a(b.charCodeAt(M)) * o;
        return p * n
    }
    function O(c) {
    ...
    function r() {
        ...
        var z, A, b, o = function() {
            ...
            for (z = 1; z < 48; z++)
                (M = new d(new Date(A,z,1))).offset !== b.offset && (c = X(b, M),
                o.push(c),
                o.push(new d(new Date(c.at + 6e4)))),
                b = M;
            for (z = 0; z < 4; z++)
                o.push(new d(new Date(A + z,0,1))),
                o.push(new d(new Date(A + z,6,1)));
            return o
        }(), p = o.length, n = function(c) {
    ...
    function u(c, M) {
        c = T(c);
        var z, A = p[c];
        return A instanceof W ? A : "string" == typeof A ? (A = new W(A),
        p[c] = A) : n[c] && M !== u && (z = u(n[c], u)) ? ((A = p[c] = new W)._set(z),
        A.name = L[c],
        A) : null
    }
    function t(c) {
    ...
    function R(c) {
        ...
        return A && !o.isMoment(c) && E(b) && b.add(A.parse(b), "minutes"),
        b.tz(z),
        b
    }
    (z < 2 || 2 === z && A < 6) && C("Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js " + o.version + ". See momentjs.com"),
    W.prototype = {
        _set: function(c) {
            this.name = c.name,
            this.abbrs = c.abbrs,
        ...
        parse: function(c) {
            ...
            for (b = 0; b < a; b++)
                ...
                z = p[b + 1],
                A = p[b ? b - 1 : b],
                M < z && R.moveAmbiguousForward ? M = z : A < M && R.moveInvalidForward && (M = A),
                o < n[b] - 6e4 * M)
                    return p[b];
            return p[a]
        },
        ...
        offset: function(c) {
            return C("zone.offset has been deprecated in favor of zone.utcOffset"),
    ...
    R.zoneExists = function c(M) {
        ...
        C("moment.tz.zoneExists('" + M + "') has been deprecated in favor of !moment.tz.zone('" + M + "')")),
        !!u(M)
    }
    ,
    R.guess = function(c) {
    ...
    R.names = function() {
        var c, M = [];
        for (c in L)
            L.hasOwnProperty(c) && (p[c] || p[n[c]]) && L[c] && M.push(L[c]);
        return M.sort()
    }
    ,
    R.Zone = W,
    ...
    o.tz = R,
    o.defaultZone = null,
    o.updateOffset = function(c, M) {
        var z, A = o.defaultZone;
        void 0 === c._z && (A && E(c) && !c._isUTC && (c._d = o.utc(c._a)._d,
        c.utc().add(A.parse(c), "minutes")),
        c._z = A),
        c._z && (z = c._z.utcOffset(c),
        Math.abs(z) < 16 && (z /= 60),
        void 0 !== c.utcOffset ? c.utcOffset(-z, M) : c.zone(z, M))
    }
    ,
    m.tz = function(c, M) {
        return c ? (this._z = u(c),
        this._z ? o.updateOffset(this, M) : C("Moment Timezone has no data for " + c + ". See http://momentjs.com/timezone/docs/#/data-loading/."),
        this) : this._z ? this._z.name : void 0
    }
    ,
    m.zoneName = D(m.zoneName),
    m.zoneAbbr = D(m.zoneAbbr),
    m.utc = (S = m.utc,
    function() {
        return this._z = null,
    ...
    o.tz.setDefault = function(c) {
        return (z < 2 || 2 === z && A < 9) && C("Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js " + o.version + "."),
        o.defaultZone = c ? u(c) : null,
        o
    }
    ;
...
;// Adds a polyfill for Object.entries for IE.
if (!Object.entries) {
